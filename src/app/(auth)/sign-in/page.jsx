...
export default function SignIn({ origin }){
    ...
    return <div className="w-full sm:w-1/2 md:w-1/5 mx-4 p-4 rounded-lg bg-zinc-800 flex flex-col items-center gap-4">
            ...
            <p className="text-center text-sm text-gray-200">{origin == 'signup' ? 'Welcome, by continuing with CMS sign in, you\'ll be a Geek' : "Welcome back, hope to have you back!" } </p>
